...
Here you can find the source code for my own personal website, built with [React](https://react.dev/), [Tailwind](https://tailwindcss.com/), [Nextjs](https://nextjs.org/), [TypeScript](https://www.typescriptlang.org/), and [Emscripten](https://emscripten.org/).
