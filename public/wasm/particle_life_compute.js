...
function findWasmBinary() {
    return locateFile('particle_life_compute.wasm');
}
...
var _compute_kernel_fast_free = Module['_compute_kernel_fast_free'] = makeInvalidEarlyAccess('_compute_kernel_fast_free');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_compute_kernel_fast_free'] = _compute_kernel_fast_free = createExportWrapper('compute_kernel_fast_free', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = particle_life_compute;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = particle_life_compute;
} else if (typeof define === 'function' && define['amd'])
  define([], () => particle_life_compute);
